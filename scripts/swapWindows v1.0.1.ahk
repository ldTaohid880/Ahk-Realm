...
#Include lib\winEventOpenClose.ahk
...
hook := WinEventHook(HandleWinEvent2)

HandleWinEvent2(hWinEventHook, event, hwnd, idObject, idChild, idEventThread, dwmsEventTime) {
    Critical -1
